...
class TestAtomisticCopy:
    ...
    def test_copy_no_orphan_bonds(self):
        ...
        assert len(orphan_bonds) == 0, f"Found {len(orphan_bonds)} orphan bonds after copy"
...
class TestMonomerCopy:
    ...
    def test_copy_no_orphan_bonds(self):
        ...
        assert len(orphan_bonds) == 0, f"Found {len(orphan_bonds)} orphan bonds in monomer copy"
