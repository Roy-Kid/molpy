...
class TestMixingRules:
    ...
    def test_geometric_mixing_rule(self):
        ...
        lj_style.def_type(c_type, c_type, parms=[0.066, 3.4])  # C-C: epsilon=0.066, sigma=3.4
        lj_style.def_type(h_type, h_type, parms=[0.030, 2.5])  # H-H: epsilon=0.030, sigma=2.5
