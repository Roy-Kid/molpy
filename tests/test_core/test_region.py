...
from molpy.core.region import (
    Region, BoxRegion, SphereRegion, Cube,
    AndRegion, OrRegion, NotRegion
)
...
class TestRegionWithBlock:
    ...
    def test_region_as_selection(self):
        ...
        from molpy.core.selection import AtomType
        ...
        # Note: Direct composition of Region & AtomType requires
