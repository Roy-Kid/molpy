...
from molpy import Atomistic, Atom, Bond, Angle, Dihedral
...
class TestOplsBondTypifier:
    ...
    def test_bond_typifier_class_matching(self):
        ...
        at3 = astyle.def_type("CB", type_="CB", class_="CT")
        at4 = astyle.def_type("HB", type_="HB", class_="HC")
...
class TestOplsAtomisticTypifier:
    ...
    def test_atomistic_typifier_typify_bonds_only(self):
        ...
        typifier = OplsAtomisticTypifier(
            ff, skip_atom_typing=True, skip_angle_typing=True, skip_dihedral_typing=True, skip_pair_typing=True
        )
