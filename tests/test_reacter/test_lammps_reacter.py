...
test_cases = [
    ...
    ([(0, 1), (1, 2), (2, 3)], 0, 3, [0, 1, 2, 3], [], "Linear chain with no branches"),
    (
        [(0, 1), (1, 2), (2, 3), (2, 4)],
        0,
        3,
...
@pytest.mark.parametrize(
    "edges,start,end,expected_path,expected_branches,desc", test_cases
)
def test_main_chain_and_branches(
    edges, start, end, expected_path, expected_branches, desc
):
