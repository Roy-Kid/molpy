        ...
        **_opts: Any,
        ...
        try:
            ...
            settings_path.write_text(
                "# fallback: no native LAMMPS FF writer output\n"
            )
        ...
        pair_styles = {s.name for s in ff.styles.bucket(type(ff.styles.bucket(object)[0]) if ff.styles.bucket(object) else object) if False}
