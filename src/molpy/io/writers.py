...
def write_lammps_data(file: PathLike, frame, atom_style: str = "full"):
    """
...
def write_pdb(file: PathLike, frame):
    """
...
def write_xsf(file: PathLike, frame):
    """
...
def write_lammps_molecule(file: PathLike, frame, format_type: str = "native"):
    """
...
def write_lammps_forcefield(file: PathLike, forcefield, precision: int = 6):
    """
...
def write_lammps_trajectory(file: PathLike, frames: List, atom_style: str = "full"):
    """
...
def write_xyz_trajectory(file: PathLike, frames: List):
    """
...
def write_lammps_system(workdir: PathLike, frame, forcefield):
    """
