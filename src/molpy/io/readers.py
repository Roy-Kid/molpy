...
def read_lammps_data(file: PathLike, atom_style: str, frame=None):
    """
...
def read_lammps_molecule(file: PathLike, frame=None):
    """
...
def read_pdb(file: PathLike, frame=None):
    """
...
def read_amber_inpcrd(inpcrd: PathLike, frame=None):
    """
...
def read_amber_ac(file: PathLike, frame=None):
    """
...
def read_mol2(file: PathLike, frame=None):
    """
...
def read_xsf(file: PathLike, frame=None):
    """
...
def read_gro(file: PathLike, frame=None):
    """
...
def read_xyz(file: PathLike, frame=None):
    """
...
def read_lammps_forcefield(scripts: PathLike | list[PathLike], forcefield=None):
    """
...
def read_xml_forcefield(file: PathLike):
    """
...
def read_amber_prmtop(prmtop: PathLike, inpcrd: PathLike | None = None, frame=None):
    """
...
def read_top(file: PathLike, forcefield=None):
    """
...
def read_lammps_trajectory(traj: PathLike, frame=None):
    """
...
def read_xyz_trajectory(file: PathLike):
    """
