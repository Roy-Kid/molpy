...
if TYPE_CHECKING:
    from ..geom.placer import Placer, GeometryContext
...
class PolymerBuilder:
    ...
    def linear(
        ...
        *,
        ...
        geom_ctx: "GeometryContext | None" = None,
    ) -> Polymer:
        """
        ...
        Args:
            ...
            geom_ctx: Optional geometry context with settings
        ...
        Example:
            ...
            ... )
            >>> # With geometry
            >>> from molpy.geom import DockPlacer, GeometryContext
            >>> poly = PolymerBuilder.linear(
            ...     sequence="TABBAT",
            ...     library={"A": A, "B": B, "T": T},
            ...     connector=AutoConnector(),
            ...     placer=DockPlacer(),
            ...     geom_ctx=GeometryContext({"vdw_scale": 0.80}),
            ... )
        """
        # Validate sequence
        if len(sequence) < 2:
        ...
        for step in range(len(sequence) - 1):
            ...
            if placer is not None:
                ...
                if geom_ctx is None:
                    from ..geom.placer import GeometryContext
...
def _apply_transform(assembly, R: list[list[float]], t: list[float]) -> None:
    ...
    """
    from ..geom.util import mat_vec_mult, vec_add
    ...
    for atom in atoms:
        ...
        pos_rotated = mat_vec_mult(R, pos)
        pos_new = vec_add(pos_rotated, t)
