...
SYMBOL = FieldSpec("symbol", np.dtype("U4"), "scalar", "chemical symbol")
...
BOND_ATOMI = FieldSpec("atomi", np.dtype(np.int64), "scalar", "first atom index (0-indexed)")
BOND_ATOMJ = FieldSpec("atomj", np.dtype(np.int64), "scalar", "second atom index (0-indexed)")
...
ANGLE_ATOMI = FieldSpec("atomi", np.dtype(np.int64), "scalar", "first atom index (0-indexed)")
ANGLE_ATOMJ = FieldSpec(
    "atomj", np.dtype(np.int64), "scalar", "vertex atom index (0-indexed)"
)
ANGLE_ATOMK = FieldSpec("atomk", np.dtype(np.int64), "scalar", "third atom index (0-indexed)")
